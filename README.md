...
- HEROKU (postgresql db, app build and deployment)
...
# The database will be available as a heroku-postgres service
# config available in .env
...
- View product details on e-commerce websites
