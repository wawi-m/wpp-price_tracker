...
heroku pg:psql --app wpp-pricetracker
...
# \COPY <your_table> FROM '<path-to-your-local-csv-file>' DELIMITER ',' CSV HEADER;
\COPY products FROM 'c:/Users/Wawi/Downloads/products.csv' DELIMITER ',' CSV HEADER;